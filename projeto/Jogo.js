export class Jogo {
    ...
    iniciarJogo() {
        ...
        if (this.pontos_A > this.pontos_B) {
            ...
            this.time_A.n_gols = this.time_A.n_gols + this.pontos_A;
            this.time_A.saldo_gols = this.time_A.saldo_gols + this.pontos_A - this.pontos_B;

            this.time_B.setDerrotas();
            this.time_B.status = 'Eliminado';
            this.time_perdeu = this.time_B;
            this.time_B.n_gols = this.time_B.n_gols + this.pontos_B;
            this.time_B.saldo_gols = this.time_B.saldo_gols + this.pontos_B - this.pontos_A;
